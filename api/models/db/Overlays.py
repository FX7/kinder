...
class Overlays(db.Model):
    ...
    def __init__(self, title: bool, duration: bool, genres: bool, watched: bool, age: bool, trailer: bool):
        self.title = title
    ...
    @staticmethod
    def create(title: bool, duration: bool, genres: bool, watched: bool, age: bool, trailer: bool):
